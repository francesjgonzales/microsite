...
if(document.addEventListener ){ 
   ...
   aLoader = [
      ...
      { load: "http://cdn.edgecommons.org/an/1.1.2/js/min/EdgeCommons.Spotlight.js", user: true },
      { load: "http://cdn.edgecommons.org/an/1.1.0/css/style.css", user: true },
      { load: "http://cdn.edgecommons.org/an/1.1.2/js/min/EdgeCommons.Parallax.js", user: true },
      { load: "SUTD_v4_edge.js"},
      { load: "SUTD_v4_edgeActions.js"}];
...
var plSTF="width",ctrPlS="horizontal",minPlW="0",maxPlW=undefined,plWidth="1200px",plHeight="800px";
